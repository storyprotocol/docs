...
<CardGroup cols={2}>
  <Card
    title="Using the SDK"
    icon="thumbs-up"
    href="/developers/typescript-sdk/attach-terms-to-an-ip-asset"
  >
  ...
  <Card
    title="Using the Smart Contracts"
    icon="thumbs-up"
    href="/developers/get-started-with-the-smart-contracts/sc-attach-license-terms"
  >
...
<CardGroup cols={1}>
  <Card
    title="Using the SDK"
    icon="thumbs-up"
    href="/developers/typescript-sdk/raise-a-dispute"
  >
