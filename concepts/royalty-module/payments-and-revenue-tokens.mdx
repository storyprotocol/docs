...
description: The requirements and details on making payments with Revenue Tokens on Story
---
...
On Aeneid testnet, we have provided a `MockERC20` token for you to be able to mint and use for testing purposes.
