...
If you'd like to jump into code examples/tutorials, please see [How to Register IP on Story](/concepts/how-to-register-ip-on-story).
...
<CardGroup cols={2}>
  ...
  <Card title="SDK Explanation" href="https://docs.story.foundation/docs/register-an-ip-asset" icon="file">
