...
<CardGroup cols={2}>
  ...
  <Card title="How to Add Metadata to an IP Asset" href="https://docs.story.foundation/docs/ip-asset#nft-vs-ip-metadata" icon="computer">
...
// get hash from a URL
async function getUrlHash(url: string): Promise<Hex> {
...
<Tabs>
  <Tab title="Ippy Mascot">
    This is the official Ippy mascot that is registered on mainnet. You can view it on our protocol explorer <a href="https://explorer.story.foundation/ipa/0xB1D831271A68Db5c18c8F0B69327446f7C8D0A42">here</a>.

    ```json
    {
      "title": "Ippy",
      "description": "Ippy is the official mascot of Story Protocol.",
      "createdAt": "2023-10-01T00:00:00.000Z",
      "image": "https://ipfs.io/ipfs/QmcK8FSTtLQVydLEDKLv1hEdzwNKEjhpPAhA1APtKjcMxY",
      "imageHash": "0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef",
      "creators": [
        {
          "name": "Story Protocol",
          "address": "0x1234567890abcdef1234567890abcdef12345678",
          "contact": "hello@story.xyz"
        }
      ],
      "mediaUrl": "https://ipfs.io/ipfs/QmcK8FSTtLQVydLEDKLv1hEdzwNKEjhpPAhA1APtKjcMxY",
  ...
  <Tab title="Music">
    This is an example song generated on <a href="https://suno.com/" >Suno</a> and registered on our testnet. View the below example <a href="https://aeneid.explorer.story.foundation/ipa/0x3E5b9e540a531da38760CC32E2f52b174EC5Fce8" >on our protocol explorer</a>.
  ...
  <Tab title="AI Agent">
    The main difference here is you should supply `aiMetadata` with a character file. You can provide any character file you want, or use <a href="https://github.com/elizaOS/characterfile/blob/main/examples/example.character.json" >this ElizaOS example</a> as a template.
...
| `appData`        | `StoryApp`         | This is assigned to verified application from Story directly (on a request basis so far). We will map each App ID to a name                                    |
