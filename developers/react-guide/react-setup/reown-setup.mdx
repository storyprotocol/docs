...
description: Learn how to setup Reown (WalletConnect) in your Story DApp.
---
...
1. Make sure to have `NEXT_PUBLIC_RPC_PROVIDER_URL` set up in your `.env` file.
   - You can use the public default one (`https://aeneid.storyrpc.io`) or any other RPC [here](/developers/aeneid#-rpcs).
