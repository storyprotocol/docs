...
- Complete [Register an IP Asset](/developers/smart-contracts-guide/register-an-ip-asset)
- Complete [Register License Terms](/developers/smart-contracts-guide/register-license-terms)
- Complete [Attach Terms to an IPA](/developers/smart-contracts-guide/attach-license-terms)
...
- Complete [Mint a License Token](/developers/smart-contracts-guide/mint-license-token)
- Complete [Register a Derivative](/developers/smart-contracts-guide/remix-ipa)
