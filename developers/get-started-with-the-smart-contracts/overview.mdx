...
**If you want to set things up from scratch**, then continue with the following tutorials, starting with the [Setup Your Own Project](/developers/get-started-with-the-smart-contracts/sc-setup) step.
