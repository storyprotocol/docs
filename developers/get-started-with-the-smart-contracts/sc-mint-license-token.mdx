...
2. An IP Asset has License Terms attached to it. You can learn how to do that [here](/developers/get-started-with-the-smart-contracts/sc-attach-license-terms)
