...
description: Learn how to register a derivative/remix IP Asset as a child of another in Solidity.
---
...
2. Have a minted License Token. You can learn how to do that [here](/developers/get-started-with-the-smart-contracts/sc-mint-license-token)
