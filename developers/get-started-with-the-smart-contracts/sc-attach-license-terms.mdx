...
2. Create License Terms and have a `licenseTermsId`. You can do that by following the [previous page](/developers/get-started-with-the-smart-contracts/sc-register-license-terms).
