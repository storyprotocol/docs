...
description: Combine all of our tutorials together in a practical example.
---
...
- Complete [Register an IP Asset](/developers/get-started-with-the-smart-contracts/sc-register-an-ip-asset)
- Complete [Register License Terms](/developers/get-started-with-the-smart-contracts/sc-register-license-terms)
- Complete [Attach Terms to an IPA](/developers/get-started-with-the-smart-contracts/sc-attach-license-terms)
...
- Complete [Mint a License Token](/developers/get-started-with-the-smart-contracts/sc-mint-license-token)
- Complete [Register a Derivative](/developers/get-started-with-the-smart-contracts/sc-remix-ipa)
