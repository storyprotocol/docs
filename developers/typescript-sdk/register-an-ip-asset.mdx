...
We can set metadata on our NFT & IP, *but you don't have to*. To do this, view the [IPA Metadata Standard](/developers/ipa-metadata-standard) and construct your metadata for both your NFT & IP.
