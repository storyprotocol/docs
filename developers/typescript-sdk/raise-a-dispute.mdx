...
This section demonstrates how to dispute an IP on Story. There are many instances where you may want to dispute an IP - whether that IP is or is not owned by you. Disputing IP on Story is easy thanks to our [Dispute Module](/developers/dispute-module) and the [UMA Arbitration Policy](/developers/uma-arbitration-policy).
...
2. Have a basic understanding of the [Dispute Module](/developers/dispute-module)
