...
This section demonstrates how to mint a [License Token](/developers/license-token) from an [IP Asset](/developers/ip-asset). You can only mint a License Token from an IP Asset if the IP Asset has [License Terms](/developers/license-terms) attached to it. A License Token is minted as an ERC-721.
...
2. An IP Asset that has License Terms added. Learn how to add License Terms to an IPA [here](/developers/typescript-sdk/attach-terms-to-an-ip-asset).
...
Be mindful that some IP Assets may have license terms attached that require the user minting the license to pay a `defaultMintingFee`. You can see an example of that in the <a href="https://github.com/storyprotocol/typescript-tutorial/blob/main/scripts/registerDerivativeCommercial.ts" >TypeScript Tutorial</a>.
...
... and more. Learn more by checking out the [License Config / Hook](/developers/license-config-hook) section of our documentation.
