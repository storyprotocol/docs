...
This section demonstrates how to attach [License Terms](/developers/license-terms) to an [IP Asset](/developers/ip-asset). By attaching terms, users can publicly mint [License Tokens](/developers/license-token) (the on-chain "license") with those terms from the IP.
...
[License Terms](/developers/license-terms) are a configurable set of values that define restrictions on licenses minted from your IP that have those terms. For example, "If you mint this license, you must share 50% of your revenue with me." You can view the full set of terms in [PIL Terms](/developers/pil-terms).
...
> Associated Docs: [license.registerPILTerms](/sdk-reference/license#registerpilterms)
...
<Card
  ...
  href="/concepts/programmable-ip-license/pil-flavors#flavor-2-commercial-use"
  icon="file"
  iconType="solid"
>
...
<Card
  ...
  href="/concepts/programmable-ip-license/pil-flavors#flavor-3-commercial-remix"
  icon="file"
  iconType="solid"
>
  ...
  <Card
    ...
    href="/concepts/programmable-ip-license/pil-flavors#flavor-4-creative-commons-attribution"
    icon="file"
    iconType="solid"
...
> Associated Docs: [license.attachLicenseTerms](/sdk-reference/license#attachlicenseterms)
