...
Creators can register their IP as [🧩 IP Assets](/ip-asset) on our protocol. IP Assets (IPA) are the foundational programmable IP metadata on the protocol. Each IPA is composed of:
...
<Accordion title="Example #1" icon="info">
...
<Accordion title="Example #2" icon="info">
