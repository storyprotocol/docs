...
<CardGroup cols={2}>
  <Card
    title="Skip the Read - 1 Minute Summary"
    icon="house"
...
<Accordion title="Why did we built Story?" icon="question">
...
Creators can register their IP as [🧩 IP Assets](/concepts/ip-asset) on our protocol. IP Assets (IPA) are the foundational programmable IP metadata on the protocol. Each IPA is composed of:
