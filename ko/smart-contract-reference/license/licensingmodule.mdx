...
LicensingModule은 Story의 라이선싱 시스템의 주요 진입점입니다. 다음과 같은 책임이 있습니다:
...
라이선스 조건이나 IP 소유자의 설정에 따라 호출자가 발행 수수료를 지불해야 할 수 있습니다. 발행 수수료는 라이선스 조건에 지정되거나 IP 소유자가 설정한 발행 수수료 토큰으로 지불됩니다.
...
라이선스 토큰 없이도 부모 IP의 라이선스 조건으로 직접 파생작을 등록하고, 부모 IP의 라이선스 조건을 파생 IP에 첨부합니다.
