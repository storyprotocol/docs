...
<Note>
  **Optional: Official RainbowKit Docs**
  ...
  공식 Wagmi + RainbowKit 설치 문서를 [여기](https://www.rainbowkit.com/docs/installation)에서 확인하세요.
</Note>
...
1. 반드시 `NEXT_PUBLIC_RPC_PROVIDER_URL`이 당신의 `.env` 파일에 설정되어 있어야 합니다.
   * 공개 기본값(`https://aeneid.storyrpc.io`)을 사용하거나 다른 RPC를 [여기](/network/network-info/aeneid#rpcs)에서 사용할 수 있습니다.
