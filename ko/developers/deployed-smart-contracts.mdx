...
description: 모든 배포된 프로토콜 주소 목록
---

## 핵심 프로토콜 컨트랙트

* GitHub에서 컨트랙트 보기 [여기](https://github.com/storyprotocol/protocol-core-v1/tree/main)
...
* GitHub에서 컨트랙트 보기 [여기](https://github.com/storyprotocol/protocol-periphery-v1)
...
* GitHub에서 컨트랙트 보기 [여기](https://github.com/storyprotocol/protocol-periphery-v1/tree/main/contracts/hooks)
...
아래 목록은 로열티 모듈에서 사용할 수 있는 화이트리스트 수익 토큰을 포함합니다. 수익 토큰에 대해 자세히 알아보기 [여기](/concepts/royalty-module/ip-royalty-vault).
