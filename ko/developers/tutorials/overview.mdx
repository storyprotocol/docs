---
title: Overview
description: 따라하기 개발자 튜토리얼 목록입니다.
---

## 등록

* [Story에서 IP를 등록하는 방법](/developers/tutorials/how-to-register-ip-on-story)
* [Story에서 음악을 등록하는 방법](/developers/tutorials/how-to-register-music-on-story)
...
* [Privy를 통한 이메일 로그인 및 스폰서 트랜잭션](/developers/tutorials/privy-tutorial)
