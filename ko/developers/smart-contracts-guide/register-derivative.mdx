...
일단[License Token](/concepts/licensing-module/license-token)이 IP 자산에서 발행되면, 해당 토큰(ERC-721 NFT)의 소유자는 이를 소각하여 자신의 IP 자산을 License Token과 연관된 IP 자산의 파생물로 등록할 수 있습니다.
