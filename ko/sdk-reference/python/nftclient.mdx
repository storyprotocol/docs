---
title: NFT Client
description: Story에서 사용할 새로운 SPG 컬렉션을 발행하는 데 사용됩니다.
---
...
* `name`: 컬렉션의 이름.
* `symbol`: 컬렉션의 심볼.
* `is_public_minting`: true인 경우 누구나 컬렉션에서 발행할 수 있습니다. false인 경우 minter 역할이 있는 주소만 발행할 수 있습니다.
* `mint_open`: 컬렉션이 생성 시 발행이 가능한지 여부.
* `mint_fee_recipient`: 발행 수수료를 받을 주소.
* `contract_uri`: 컬렉션의 계약 URI. ERC-7572 표준을 따릅니다. 참조: [here](https://eips.ethereum.org/EIPS/eip-7572).
