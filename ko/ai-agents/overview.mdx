...
<CardGroup cols={2}>
  <Card title="Train on Our Docs" href="https://github.com/storyprotocol/docs/blob/main/combined.md" icon="robot" color="#4e8189">
    우리의 문서를 AI 에이전트의 학습 데이터로 사용하고 싶으신가요? 모든 문서가 하나로 통합된 이 파일을 확인해보세요`.md` 파일.
  </Card>
...
Story에서 AI 에이전트(또는 IP)를 등록하기 위해서는 [Story에서 IP 등록하는 방법](/developers/tutorials/how-to-register-ip-on-story) 튜토리얼을 따르세요. AI 에이전트의 경우 유일한 차이점은 [📝 IPA Metadata Standard](/concepts/ip-asset/ipa-metadata-standard)를 따르는 IP 메타데이터 구조입니다.
