...
| `image`       | `string`      | An image for your IP.                                                                                                                                                                           | 🔍 Story Explorer                                                       |
...
| `mediaUrl`    | `string`      | Used for infringement checking, points to the actual media (ex. image or audio)                                                                                                                 | 🕵️ [Commercial Infringement Check](/concepts/story-attestation-service) |
...
<Accordion title="Creating your own custom ERC-721 collection" icon="info-circle">
