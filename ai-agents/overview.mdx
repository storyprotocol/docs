...
<CardGroup cols={2}>
  <Card title="Using the SDK" href="/developers/typescript-sdk/attach-terms-to-an-ip-asset" icon="house">
    Learn how to attach terms to your AI Agent using the SDK.
  </Card>

  <Card title="Using the Smart Contracts" href="/developers/get-started-with-the-smart-contracts/sc-attach-license-terms" icon="house">
