...
| Aeneid  | v1.1.1 (Cosmas) | v1.4.0 (Terence)  |

<Update label="2025-10-31" description="Terence (Story v1.4.0)">
    ### Polybius
    [Full release note](https://github.com/piplabs/story/releases/tag/v1.4.0)
