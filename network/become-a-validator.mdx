...
- `--explorer`: Specifies the URL of the blockchain explorer (default: [https://storyscan.io](https://storyscan.io)).
...
- `--explorer`: (string) URL of the blockchain explorer (default: "[https://storyscan.io](https://storyscan.io)")
